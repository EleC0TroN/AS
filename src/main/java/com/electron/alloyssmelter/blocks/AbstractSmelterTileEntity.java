...
public abstract class AbstractSmelterTileEntity extends LockableTileEntity implements ISidedInventory, IRecipeHolder, IRecipeHelperPopulator, ITickableTileEntity {
    private static final int[] SLOTS_UP = new int[]{0, 3};
    ...
    protected final IIntArray furnaceData = new IIntArray() {
        public int get(int index) {
            switch(index) {
                case 0:
                    return AbstractSmelterTileEntity.this.burnTime;
                case 1:
                    return AbstractSmelterTileEntity.this.recipesUsed;
                case 2:
                    return AbstractSmelterTileEntity.this.cookTime;
                case 3:
                    return AbstractSmelterTileEntity.this.cookTimeTotal;
                default:
                    return 0;
            }
        }
        ...
        public void set(int index, int value) {
            switch(index) {
                case 0:
                    AbstractSmelterTileEntity.this.burnTime = value;
                    break;
                case 1:
                    AbstractSmelterTileEntity.this.recipesUsed = value;
                    break;
                case 2:
                    AbstractSmelterTileEntity.this.cookTime = value;
                    break;
                case 3:
                    AbstractSmelterTileEntity.this.cookTimeTotal = value;
            }
    ...
    protected final IRecipeType<? extends AbstractSmelterRecipe> recipeType;

    protected AbstractSmelterTileEntity(TileEntityType<?> tileTypeIn, IRecipeType<? extends AbstractSmelterRecipe> recipeTypeIn) {
        super(tileTypeIn);
    ...
    public static Map<Item, Integer> getBurnTimes() {
        ...
        addItemBurnTime(map, ModItems.MELTING_CORE, 10000);
    ...
    public void tick() {
        ...
        if (!this.world.isRemote) {
            ...
            if (this.isBurning() || !itemstack.isEmpty() && !this.items.get(0).isEmpty()) {
                IRecipe<?> irecipe = this.world.getRecipeManager().getRecipe((IRecipeType<AbstractSmelterRecipe>)this.recipeType, this, this.world).orElse(null);
            ...
            if (flag != this.isBurning()) {
                flag1 = true;
                this.world.setBlockState(this.pos, this.world.getBlockState(this.pos).with(AbstractSmelterBlock.LIT, Boolean.valueOf(this.isBurning())), 3);
            }
        }
    ...
    protected boolean canSmelt(@Nullable IRecipe<?> recipeIn) {
        if (!this.items.get(0).isEmpty() && !this.items.get(0).isEmpty() && recipeIn != null) {
    ...
    protected int getCookTime() {
        return this.world.getRecipeManager().getRecipe((IRecipeType<AbstractSmelterRecipe>)this.recipeType, this, this.world).map(AbstractSmelterRecipe::getCookTime).orElse(200);
    }
    ...
    public List<IRecipe<?>> func_235640_a_(World p_235640_1_, Vector3d p_235640_2_) {
        ...
        for(Object2IntMap.Entry<ResourceLocation> entry : this.field_214022_n.object2IntEntrySet()) {
            p_235640_1_.getRecipeManager().getRecipe(entry.getKey()).ifPresent((p_235642_4_) -> {
                ...
                func_235641_a_(p_235640_1_, p_235640_2_, entry.getIntValue(), ((AbstractSmelterRecipe)p_235642_4_).getExperience());
            });
        }
