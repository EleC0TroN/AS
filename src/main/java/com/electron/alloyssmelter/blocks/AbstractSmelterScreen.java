...
@OnlyIn(Dist.CLIENT)
public abstract class AbstractSmelterScreen<T extends AbstractSmelterContainer> extends ContainerScreen<T> {

    private boolean widthTooNarrowIn;
    private final ResourceLocation guiTexture;

    public AbstractSmelterScreen(T screenContainer, PlayerInventory inv, ITextComponent titleIn, ResourceLocation guiTextureIn) {
